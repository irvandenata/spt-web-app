      ...
      <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
        <div class="app-brand demo">
          <a href="/admin/dashboard" class="app-brand-link">
            ...
            <span class="demo menu-text fw-bolder ms-2 " style="margin-left: 10px !important; font-size:20px">{{ App\Helpers\View::websiteName() }}</span>
          </a>
        ...
        <ul class="menu-inner py-1">
          ...
          <li class="menu-item @if (Request::is('admin/projects*')) active @endif">
