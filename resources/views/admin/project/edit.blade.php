            ...
            <div class="row">
              ...
              <div class="form-group mb-3 col-6">
                <div class="form-line">
                  ...
                  <input type="number" name="order" class="form-control" min="0" value="{{ $item->order }}" required>
                </div>
              </div>
              ...
              <div class="form-group mb-3 col-12">
                <div class="form-line">
                  ...
                  <textarea name="description" id="myeditorinstance" class="form-control" id="description" rows="4" >{{ $item->description }}</textarea>
                </div>
              </div>
              <div class="form-group mb-3 col-12">
                <div class="form-line">
                  ...
                  <div class="row">
                    <div id="preview" class="pb-2 mr-2 col-4">
                      <img src="/storage/{{ $item->image }}" class="" height="200px"  style="object-fit:contain;  max-width: 320px !important;"  alt="">
                    </div>
              ...
              <div class="form-group col-12">
                ...
                <table class="table table-bordered" id="additionalImageTabel">
                  ...
                  <tbody>
                    @if ($item->imageProjects->count())
                    @foreach ($item->imageProjects()->orderBy('order')->get() as $key => $image)
                    <tr id="image-{{ $key+1 }}" draggable="true">
                        <input type="hidden" class="idImage" name="idImage[]" value="{{ $image->id }}">
                        <td class="box-move">
                        ...
                        <th scope="row">{{ $loop->iteration }}<input type="hidden" class="indextd" draggable="true" value="{{ $key+1 }}"></th>
                        <td>
                          <img src="{{($image->image_url?"/storage/$image->image_url":asset('assets/img/no-image.png')) }}" alt="image" class="img-thumbnail w-25 h-25  mb-3 cursor-pointer"
                        ...
                        <td><input type="text" class="form-control caption" name="caption[]" id="caption"
                            value="{{ $image->caption  }}" placeholder="Enter Caption"></td>
                        </td>

                        <td>
                          <input type="hidden" class="idRow" value="{{ $key+1 }}">
                    ...
                    <tr id="image-1" draggable="true">
                        <input type="hidden" class="idImage" name="idImage[]" value="">
                        <td class="box-move">
                          <div class="move-image text-center">
                            <svg xmlns="http://www.w3.org/200/svg" width="15" viewBox="0 0 320 512">
                              <path
  ...
  <script>
    ...
    $("#addAdditionalImage").on('click', function() {
      ...
      let html = `<tr id="image-` + list + `" draggable="true">
            <input type="hidden" class="idImage" name="idImage[]">
            <td class="box-move">
                                  <div class="move-image text-center">
                                    <svg xmlns="http://www.w3.org/200/svg" width="15" viewBox="0 0 320 512">
                                      <path
    ...
    function switchListImage(current, target) {
      ...
      if (parseInt(current) < parseInt(target)) {
        for (let index = parseInt(current); index < target; index++) {
          ...
          let image = row.find('.idImage').val();
          ...
          let imageNext = rowNext.find('.idImage').val();
          ...
          rowNext.find('.idImage').val(image);
          ...
          row.find('.idImage').val(imageNext);
