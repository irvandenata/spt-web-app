...
{
    protected $name = 'Data Anggaran Sewa Kendaraan';

    public function __construct()
    {
        $this->newModel = new RentalCost();
        $this->model = RentalCost::query();
        $this->modul = 'rentalCost';
    }
  ...
  /**
    ...
    {
        if ($request->ajax()) {
            $items = $this->model->latest()->with('province')->get();
