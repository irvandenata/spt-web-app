...
use App\Models\LodgingCost;
use Illuminate\Http\Request;
use Illuminate\Support\Facades\DB;
use Illuminate\Support\Facades\Validator;
use Yajra\DataTables\Facades\DataTables;

class LodgingCostController extends Controller
{
    protected $name = 'Data Anggaran Uang Penginapan';

    public function __construct()
    {
        $this->newModel = new LodgingCost();
        $this->model = LodgingCost::query();
        $this->modul = 'lodgingCost';
    }
  ...
  /**
    ...
    {
        if ($request->ajax()) {
            $items = $this->model->latest()->with('district')->get();
